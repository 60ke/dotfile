...
function config.everforest()
	vim.g.everforest_contrast = true
	vim.g.everforest_borders = false
	vim.g.everforest_cursorline_transparent = true
	vim.g.everforest_disable_background = false
	vim.g.everforest_enable_sidebar_background = true
	vim.g.everforest_italic = true
end
